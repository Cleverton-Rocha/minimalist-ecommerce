        ...
        <div id="home-container" className='relative p-12'>
          <div className='flex flex-col md:flex-row justify-center gap-5'>
            ...
            <Link to="/categories/fornitures" className='flex' >
              ...
              <p className='absolute text-white font-semibold text-xl md:text-4xl lg:text-5xl ml-4 mt-48 md:bottom-20'>Fornitures</p>
            </Link>
            ...
            <Link to="/categories/kitchen" className='flex' >
              ...
              <p className='absolute text-white font-semibold text-xl md:text-4xl lg:text-5xl ml-4 mt-56 md:bottom-20'>Kitchen</p>
            </Link>
            ...
            <Link to="/categories/eletronics" className='flex'>
              ...
              <p className='absolute text-white font-semibold text-xl md:text-4xl lg:text-5xl ml-4 mt-40 md:bottom-20'>Eletronics</p>
            </Link>
