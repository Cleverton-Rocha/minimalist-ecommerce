...
function ProductCard(props) {
  return (
    ...
    <Link to={`/product/${props.id}`} className='flex flex-col justify-between border-2 border-gray-300 rounded-sm hover:border-gray-600 transition duration-300 w-64'>
      <div className='p-12'>
